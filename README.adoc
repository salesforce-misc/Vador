...
=== 🍭 link:docs/config-dsl/config-driven-validation.adoc[Config Driven Validation]
...
[.lead]
The framework asks your validation strategy to be broken into 3 *_decoupled_* parts:
...
TIP: If you are using link:docs/config-dsl/config-driven-validation.adoc[Config DSL] from 2.0, you don't need to worry about this, unless you are particular about the order of validators.
