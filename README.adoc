...
.link:{testdir}/org/revcloud/vador/execution/VadorTest.java[VadorTest.java, tag=withValidators]
----
...
[source,java,indent=0,options="nowrap"]
.link:{testdir}/org/revcloud/vador/execution/VadorTest.java[VadorTest.java, tag=failFastDemo]
----
include::{testdir}/org/revcloud/vador/execution/VadorTest.java[tag=failFastDemo]
----
