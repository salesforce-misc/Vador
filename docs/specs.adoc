...
On a shared codebase, same algorithms get written in different styles. This leads to increase of entropy, maintenance and coverage overhead in a codebase.
...
Wait! Before you scream! Hear out the rationale behind this *Recommendation*.
...
Currently Vader provides 3 types of Specs and their names reflect the arity of fields they deal with. The declarative DSL with intuitive method names should guide the developer to construct a Spec.
