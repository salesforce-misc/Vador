...
Dont' worry, different flavors of link:config-dsl/dsl-driven-configuration.adoc[Config DSLs] are here to co-pilot with you, to prepare the config instance as per your validation requirements.
