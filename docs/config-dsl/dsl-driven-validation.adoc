...
Vader has a powerful and declarative Configuration https://blog.jetbrains.com/kotlin/2011/10/dsls-in-kotlin-part-1-whats-in-the-toolbox-builders/[DSL].
...
=== link:nested/NestedBatch1ValidationConfig.adoc[NestedBatch1ValidationConfig(TBD)]

=== link:nested/BatchOfBatch1ValidationConfig.adoc[BatchOfBatch1ValidationConfig]
