...
----
include::{testdir-kotlin}/com/salesforce/vador/execution/config/BaseValidationConfigTestFixtures.kt[tag=flat-bean]
----
...
[source,kotlin,indent=0,options="nowrap"]
----
include::{testdir-kotlin}/com/salesforce/vador/execution/config/BaseValidationConfigTestFixtures.kt[tag=nested-bean]
----
