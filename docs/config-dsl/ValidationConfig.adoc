...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/config/BaseValidationConfigTest.java[tag=flat-bean]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/config/BaseValidationConfigTest.java[tag=validationConfig-for-flat-bean-demo]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/config/BaseValidationConfigTest.java[tag=nested-bean]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/config/BaseValidationConfigTest.java[tag=validationConfig-for-nested-bean-demo]
----
