...
TIP: Before diving into the examples, you may find this comparison useful: link:dsl-driven-configuration.adoc#_containervalidationconfig_vs_validationconfig[ContainerValidationConfig++*++ Vs ++*++ValidationConfig].
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/runner/config/ContainerValidationConfigTest.java[tag=container-config-level-1-container-with-multi-batch]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/runner/config/ContainerValidationConfigTest.java[tag=container-config-level-1-container-with-multi-batch-demo]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/runner/config/ContainerValidationConfigTest.java[tag=container-config-level-1-container-with-container-batch]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/runner/config/ContainerValidationConfigTest.java[tag=container-config-level-1-container-with-container-batch-demo]
----
