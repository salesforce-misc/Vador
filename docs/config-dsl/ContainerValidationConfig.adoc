...
----
include::{testdir-kotlin}/com/salesforce/vador/execution/config/ContainerValidationConfigTestFixtures.kt[tag=container-config-level-1-container-with-multi-batch]
----
...
[source,kotlin,indent=0,options="nowrap"]
----
include::{testdir-kotlin}/com/salesforce/vador/execution/config/ContainerValidationConfigTestFixtures.kt[tag=container-config-level-1-container-with-container-batch]
----
