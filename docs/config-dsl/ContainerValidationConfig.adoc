...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/config/ContainerValidationConfigTest.java[tag=container-config-level-1-container-with-multi-batch]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/config/ContainerValidationConfigTest.java[tag=container-config-level-1-container-with-multi-batch-demo]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/config/ContainerValidationConfigTest.java[tag=container-config-level-1-container-with-container-batch]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/config/ContainerValidationConfigTest.java[tag=container-config-level-1-container-with-container-batch-demo]
----
