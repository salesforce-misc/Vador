...
TIP: Before diving into the examples, you may find this comparison useful: link:dsl-driven-validation.adoc#_containervalidationconfig_vs_validationconfig[ContainerValidationConfig++*++ Vs ++*++ValidationConfig].
