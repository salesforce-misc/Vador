...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vador/execution/config/IDConfigTest.java[tag=bean-with-id-fields]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vador/execution/config/IDConfigTest.java[tag=bean-strict-id-validation]
----
