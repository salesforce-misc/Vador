...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vador/execution/config/nested/BatchOfBatch1ValidationConfigTest.java[tag=batch-of-batch-1]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vador/execution/config/nested/BatchOfBatch1ValidationConfigTest.java[tag=batch-of-batch-1-demo]
----
