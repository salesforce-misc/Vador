...
[source,java,indent=0,options="nowrap"]
.link:{testdir}/org/revcloud/vader/execution/VaderTest.java[VaderTest.java, tag=withValidators]
----
...
.link:{testdir}/org/revcloud/vader/execution/VaderTest.java[VaderTest.java, tag=withValidators]
----
include::{testdir}/org/revcloud/vader/execution/VaderTest.java[tag=withValidators]
----
