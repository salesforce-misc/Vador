...
.link:{testdir-kotlin}/com/salesforce/vador/execution/UtilsTestFixtures.kt[UtilsTestFixtures.kt,tag=batch-bean]
----
include::{testdir-kotlin}/com/salesforce/vador/execution/UtilsTestFixtures.kt[tag=batch-bean]
----
...
[source,java,indent=0,options="nowrap"]
.link:{testdir}/com/salesforce/vador/execution/UtilsTest.java[UtilsTest.java,tag=batch-bean-demo]
----
...
[source,kotlin,indent=0,options="nowrap"]
----
include::{testdir-kotlin}/com/salesforce/vador/execution/UtilsTestFixtures.kt[tag=batch-bean-multikey]
----
