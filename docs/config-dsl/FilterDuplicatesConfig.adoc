...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/UtilsTest.java[tag=batch-bean]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/UtilsTest.java[tag=batch-bean-demo]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/UtilsTest.java[tag=batch-bean-multikey]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/execution/UtilsTest.java[tag=batch-bean-multikey-demo]
----
