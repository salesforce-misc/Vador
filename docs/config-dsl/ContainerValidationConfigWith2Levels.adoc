...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/runner/config/nested/ContainerValidationConfigWith2LevelsTest.java[tag=container-config-level-2]
----
...
void containerValidationConfigWith2Levels1() {
  ...
  final var result =
      Vader.validateAndFailFastForContainer(containerRoot, containerRootValidationConfigFor2Levels)
          .or(
              () ->
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vader/runner/config/nested/ContainerValidationConfigWith2LevelsTest.java[tag=container-config-level-2-demo]
----
