...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vador/execution/config/nested/ContainerValidationConfigWith2LevelsTest.java[tag=container-config-level-2]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{testdir}/org/revcloud/vador/execution/config/nested/ContainerValidationConfigWith2LevelsTest.java[tag=container-config-level-2-demo]
----
