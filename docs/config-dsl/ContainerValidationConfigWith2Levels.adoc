...
:testdir-kotlin: ../../vador/src/test/kotlin
...
.link:{testdir-kotlin}/com/salesforce/vador/execution/config/nested/ContainerValidationConfigWith2LevelsTestFixtures.kt[ContainerValidationConfigWith2LevelsTestFixtures.kt, tag=container-config-level-2]
----
include::{testdir-kotlin}/com/salesforce/vador/execution/config/nested/ContainerValidationConfigWith2LevelsTestFixtures.kt[tag=container-config-level-2]
----
...
[source,java,indent=0,options="nowrap"]
.link:{testdir}/com/salesforce/vador/execution/config/nested/ContainerValidationConfigWith2LevelsTest.java[ContainerValidationConfigWith2LevelsTest.java, tag=container-config-level-2-demo]
----
@DisplayName(
