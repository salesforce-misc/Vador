...
class AggregationLiftDslTest {
    ...
    void liftToParentValidationType() {
        ...
        val liftedParentValidator = AggregationLiftDsl.liftToContainerValidationType(childValidator, BaseParent::getChild, null, null);
    ...
    void liftToParentValidationTypeInvalidParent() {
        ...
        val liftedParentValidator = AggregationLiftDsl.liftToContainerValidationType(childValidator, BaseParent::getChild, ValidationFailure.INVALID_PARENT, null);
    ...
    void liftToParentValidationTypeInvalidChild() {
        Validator<Child, ValidationFailure> childValidator = child -> Either.left(ValidationFailure.VALIDATION_FAILURE_1);
        val liftedParentValidator = AggregationLiftDsl.liftToContainerValidationType(childValidator, BaseParent::getChild, null, ValidationFailure.INVALID_CHILD);
        Assertions.assertEquals(Either.left(ValidationFailure.INVALID_CHILD), liftedParentValidator.unchecked().apply(Either.right(new BaseParent(0, null, null))));
    }
    ...
    void liftToParentValidationType2() {
        ...
        val liftedParentValidator = AggregationLiftDsl.liftToContainerValidationType(childValidator, BaseParent::getChild, null);
        final Child toBeValidatedChild = new Child(0);
        val toBeValidated = new BaseParent(0, null, toBeValidatedChild);
        Assertions.assertEquals(Either.right(toBeValidatedChild), liftedParentValidator.unchecked().apply(Either.right(toBeValidated)));
    }
    ...
    void liftToParentValidationType2InvalidParent() {
        Validator<Child, ValidationFailure> childValidator = child -> Either.left(ValidationFailure.VALIDATION_FAILURE_1);
        val liftedParentValidator = AggregationLiftDsl.liftToContainerValidationType(childValidator, BaseParent::getChild, ValidationFailure.INVALID_PARENT);
        Assertions.assertEquals(Either.left(ValidationFailure.INVALID_PARENT), liftedParentValidator.unchecked().apply(Either.right(null)));
    }
