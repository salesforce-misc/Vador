...
class BatchRunnerTest {
    ...
    void failFastPartialFailures() {
        ...
        val results = BatchRunner.validateAndFailFast(validatables, validators, null, throwable -> null);
    ...
    void failFastPartialFailuresForSimpleValidators() {
        ...
        val result = BatchRunner.validateAndFailFast(validatables, simpleValidators, null, NONE, throwable -> null);
